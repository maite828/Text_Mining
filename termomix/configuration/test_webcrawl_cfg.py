...
clf_train_cfg = {
    ...
    "data_path": "test/test-data/webcrawl",
    # Source_names contains file names of each source. They are expected to be into data_path dir
    "train_src_names": ["part-r-00000.detid.clean.little"],
    "categories_csv": "test/test-data/webcrawl/domains_categories.csv",
...
wordcloud_cfg = {
    ...
    "output_path": "test/test-data/webcrawl/",
    "language_filter": "ENG",
    "language_trust_filter": 50,

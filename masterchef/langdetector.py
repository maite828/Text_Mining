...
def _calculate_languages_ratios(text, stopwords, languages):
    """
...
def detect_language(text, stopwords, languages):
    """
    Calculate probability of given text to be written in several languages and
    ...
    @rtype: str
    """
    ratios = _calculate_languages_ratios(text, stopwords, languages)
